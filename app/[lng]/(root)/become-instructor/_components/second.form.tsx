						...
						<FormItem>
							...
							<FormControl>
								<Input
									...
									placeholder='https://mustafoAlisherovich.uz'
								/>
							</FormControl>
						</FormItem>
					)}
						...
						<FormItem>
							...
							<FormControl>
								<Input
									{...field}
									className='bg-primary/10'
									placeholder='https://linkedin.com/in/MustafoAlisherovich'
								/>
							</FormControl>
						</FormItem>
					)}
						...
						<FormItem>
							...
							<FormControl>
								<Input
									{...field}
									className='bg-primary/10'
									placeholder='https://github.com/MustafoAlisherovich'
								/>
							</FormControl>
						</FormItem>
					)}
						...
						<FormItem>
							...
							<FormControl>
								<Input
									{...field}
									className='bg-primary/10'
									placeholder='https://youtube.com/mustafoAlisherovic'
								/>
							</FormControl>
						</FormItem>
					)}
